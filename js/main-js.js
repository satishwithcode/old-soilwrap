...
(() =>{
  ...
  const oneHamburgerBtn = document.querySelector(".one-hamburger-btn"),
  one = document.querySelector(".one"),
  closePopupBtn = one.querySelector(".close-popup-menu");

  oneHamburgerBtn.addEventListener("click", showOne);
  closePopupBtn.addEventListener("click", hideOne);
...
(() =>{
  ...
  const secondHamburgerBtn = document.querySelector(".second-hamburger-btn"),
  second = document.querySelector(".second"),
  closePopupBtn = second.querySelector(".close-popup-menu");

  secondHamburgerBtn.addEventListener("click", showSecond);
  closePopupBtn.addEventListener("click", hideSecond);
...
(() =>{
  ...
  const thirdHamburgerBtn = document.querySelector(".third-hamburger-btn"),
  third = document.querySelector(".third"),
  closePopupBtn = third.querySelector(".close-popup-menu");

  thirdHamburgerBtn.addEventListener("click", showThird);
  closePopupBtn.addEventListener("click", hideThird);
